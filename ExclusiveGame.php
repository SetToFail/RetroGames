...
<body>
	<header class="headerr">
		<div style="display: flex;">
			...
			<a href="">	<img src="../Images/Logo.png" class="logo" style="pointer-events: none;">
			</a>
	...
	<div style="display:flex;">
		...
		<iframe onload="undefined" src="https://g2.igroutka.ru/games/72/nu_pogodi/wolf-on-the-farm/" width="100%" height="500px" scrolling="no" frameborder="0" allowfullscreen="true" id="emul"></iframe>
